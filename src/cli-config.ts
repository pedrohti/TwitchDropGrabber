export const usageOptions = [
	...
	},
	{
		header: 'Synopsis',
		content: [
			'$ npm start -- [-v] [-t 60000] [-n | --no-headless] [-p "localhost:1234"] [-g] valorant',
	...
	},
	{
		...
		optionList: [
			...
			},
			{
				...
				type: Boolean,
				description:
					'Keep searching for channels with active drops'
			},
			{
				name: 'verbose',
				alias: 'v',
...
export const cmdOptions = [
	...
	{ name: 'infinity', alias: 'i', type: Boolean, defaultValue: false },
	{ name: 'verbose', alias: 'v', type: Boolean, defaultValue: false },
	{ name: 'help', alias: 'h', type: Boolean, defaultValue: false },
	{ name: 'no-headless', alias: 'n', type: Boolean, defaultValue: false },
